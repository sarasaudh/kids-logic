...
class LogicPosts {
    static let posts = [
        Logic(image: "1", caption: "🐼", title:(NSLocalizedString("ALGORITHM", comment: "")), desc: (NSLocalizedString("1: Think of it this way: many introductory lessons introduce algorithms as mathematical “recipes”; and like a recipe, algorithms contain clear steps working towards an established result. ", comment: "")), author: "🐼", lessonNum: "1"),
