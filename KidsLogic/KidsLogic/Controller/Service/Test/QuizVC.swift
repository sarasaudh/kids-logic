...
//            questionCounter.leftAnchor.constraint(equalTo: view.leftAnchor,constant: 200),
            ...
            optionA.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -50),
            optionA.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 50),
            optionA.heightAnchor.constraint(equalToConstant: 70),
           
            optionB.topAnchor.constraint(equalTo: optionA.bottomAnchor, constant: 5),
            optionB.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -50),
            optionB.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 50),
            optionB.heightAnchor.constraint(equalToConstant: 70),
       
            optionC.topAnchor.constraint(equalTo: optionB.bottomAnchor, constant: 5),
            optionC.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -50),
            optionC.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 50),
            optionC.heightAnchor.constraint(equalToConstant: 70),
       
            optionD.topAnchor.constraint(equalTo: optionC.bottomAnchor, constant: 5),
            optionD.rightAnchor.constraint(equalTo: view.rightAnchor, constant: -50),
            optionD.leftAnchor.constraint(equalTo: view.leftAnchor, constant: 50),
